  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-zinc-50 px-4 dark:bg-black'>
      <div className='w-full max-w-md'>
        <div className='rounded-lg bg-white px-8 py-10 shadow-sm dark:bg-zinc-900'>
          <h1 className='mb-8 text-center text-3xl font-semibold text-black dark:text-zinc-50'>
            Sign In
          </h1>

          {error && (
            <div className='mb-6 rounded-md bg-red-50 px-4 py-3 text-sm text-red-800 dark:bg-red-900/20 dark:text-red-400'>
              {error}
            </div>
          )}
          ...
          <button
            ...
            className='mb-3 flex w-full items-center justify-center gap-3 rounded-md border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-900 transition-colors hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700'
          >
          ...
          <button
            ...
            className='mb-6 flex w-full items-center justify-center gap-3 rounded-md border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-900 transition-colors hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700'
          >
            <svg className='h-5 w-5' viewBox='0 0 24 24' fill='currentColor'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div>
              ...
              <input
                ...
                className='mt-2 block w-full rounded-md border border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 placeholder-zinc-400 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder-zinc-500 dark:focus:border-zinc-600 dark:focus:ring-zinc-600'
